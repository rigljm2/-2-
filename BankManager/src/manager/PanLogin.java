...
public class PanLogin extends JPanel implements ActionListener
{
    ...
    private void InitGUI()
    {
        ...
        Label_Title = new JLabel("관리자 로그인");
    ...
    //                ManagerMain의 Send 기능을 호출하여 서버에 로그인 요청 메시지를 전달 하는 기능.
    //*******************************************************************
    public void Login()
    {
        ...
        MainFrame.userId = id;
        MainFrame.send(new CommandDTO(RequestType.LOGIN_MANAGER, id, password), new CompletionHandler<Integer, ByteBuffer>()
        {
            @Override
