...
{
    private JLabel Label_userAccount;
    ...
    private void InitGUI()
    {
        ...
        Label_userAccount = new JLabel("출금 계좌번호");
        Label_userAccount.setBounds(0,70,100,20);
        Label_userAccount.setHorizontalAlignment(JLabel.LEFT);
        add(Label_userAccount);

        Text_userAccount = new JTextField();
        Text_userAccount.setBounds(100,70,350,20);
        Text_userAccount.setEditable(true);
        Text_userAccount.setToolTipText("숫자만 입력");
        add(Text_userAccount);
    ...
    {
        String withdrawAccountNo = Text_userAccount.getText();
        String receiveAccountNo = Text_RecvAccount.getText();
        long amount = Long.parseLong(Text_Amount.getText().isEmpty() ? "0" : Text_Amount.getText());
        String password = Text_Password.getText();

        CommandDTO commandDTO = new CommandDTO(RequestType.TRANSFER ,password, withdrawAccountNo, receiveAccountNo, amount);
